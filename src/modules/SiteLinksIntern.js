...
function SiteLinksIntern(props) {
    ...
    return (
      <div className="SiteLinksIntern">
        ...
        <NavLink className="Link" onClick={props.toggleMenu} style={props.stylesContentEnglish} to="/myproject">My Project</NavLink>
        <NavLink className="Link" onClick={props.toggleMenu} style={props.stylesContentGerman} to="/myproject">Mein Projekt</NavLink>
